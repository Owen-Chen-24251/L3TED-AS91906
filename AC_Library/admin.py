...
from .models import Student, Genre, Book, Issue, Return, ContactForm
...
class IssueAdmin(admin.ModelAdmin):
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
            ...
            return super().formfield_for_foreignkey(db_field, request, **kwargs) # Returns the form field with students who have issued a book.
...
class ReturnAdmin(admin.ModelAdmin):
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
            ...
            return super().formfield_for_foreignkey(db_field, request, **kwargs) # Returns the form field with filtered books that haven't been returned.
